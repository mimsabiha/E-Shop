...
export const getAllProducts=()=>async dispatch=>{
        ...
        try {
            const response = await axios.get('http://localhost:8000/storeAPI/products/getAllProducts')
...
export const addNewProducts=(product)=>async dispatch=>{
    ...
    try {
        const response = await axios.post('http://localhost:8000/storeAPI/products/addNewProduct',product)
        console.log(response)
